...
public class InterceptAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intercept_address);
        ...
        //长按删除
        listViewAddress.setOnItemLongClickListener(onItemLongClickListener);

    }

    /*初始化*/
    private void init() {
        listViewAddress = (ListView) findViewById(R.id.lvAddress);
        btnAdd = (Button) findViewById(R.id.btnAddAddress);
        context = InterceptAddressActivity.this;
    ...
    protected View.OnClickListener btnAddListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            //号码输入编辑
            View addLayout = getLayoutInflater().inflate(R.layout.list_cell_address, null);
            etAddress = (EditText) addLayout.findViewById(R.id.etAddress);
            ...
            addBuilder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    String strAddress = etAddress.getText().toString().trim();//去除字符串前后空格

                    //判断字符串非空以及之前是否输入过
                    if ((!strAddress.equals("")) && (!list.contains(strAddress))) {
    ...
    public boolean saveArray(ArrayList<String> list) {
        SharedPreferences sp = this.getSharedPreferences("listAddress", MODE_APPEND);
